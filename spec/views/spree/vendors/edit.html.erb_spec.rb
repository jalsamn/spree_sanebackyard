...
RSpec.describe "spree/vendors/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit spree_vendor form" do
    render

    assert_select "form[action=?][method=?]", spree_vendor_path(@spree_vendor), "post" do
